...
export class FiltroPeliculasComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, //1 crear formBulder
    ...
    private activatedRoute: ActivatedRoute) { }  // 18// leer valores de URL  y que cuando se copie y pegue el link tome los filtros
...
formularioOriginal = {
  ...
  ngOnInit(): void {   // 4 definir y escribir los parámetros
    ...
    this.form.valueChanges  //12 retorna un observable / es decir nos permite subcribir a los eventos que se van a disparar
    .subscribe(valores => {
      //console.log(valores);  // mientras vamos seleciona o escribiendo se va a ir consultando / el log es para validar nada mas
      this.peliculas = this.peliculasOriginal;// restear cada vez que se haga una busqueda
